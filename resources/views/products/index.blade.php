...
@section('content')
    <section
        style="background-image: url('https://norsecare.co.uk/wp-content/uploads/2023/03/5-delicious-fruits-with-great-health-benefits.png'); background-size: cover; background-position: center; background-color: rgba(72, 53, 53, 0);">
        <div class="relative p-3 py-12 sm:py-16 lg:pt-20 xl:pb-0">
            <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 p-8">
                <div class="mx-auto max-w-3xl text-center">
                    <h1
                        class="mt-5 text-3xl font-light leading-tight text-white text-gray-900 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight">
                        Welcome to EcomShop, <br class="sm:hidden" />
                        <span class="relative inline-flex justify-center whitespace-nowrap font-bold">
                            Shop now and taste <br>
                            the difference!
                            <svg class="absolute -bottom-8 hidden w-2/3 text-gray-400 sm:block" viewBox="0 0 490 42"
                    ...
                    <p class="mx-auto mt-12 max-w-md leading-5 text-white text-gray-600">your one-stop shop for fresh, organic
                        vegetables and fruits delivered straight to your doorstep. Explore our vibrant selection of locally
                        sourced produce, bursting with flavor and nutrients. From crisp apples to leafy greens,
                        we've got everything you need to fuel your healthy lifestyle.</p>

                    <div class="group relative mt-10 inline-flex">
                        <a href="/register" title=""
                            class="rounded-xl bg-blue-700 px-10 py-3 font-medium text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 hover:bg-blue-600">Get
                            free trial</a>
                        <div
                            class="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-blue-600 md:inline-flex">
    ...
    <section>
        <div class="bg-white-100 p-6">
            <div class="container mx-auto pt-12">
                <h1 class="text-4xl font-bold text-black-800 text-center mb-8">
                    Welcome to my Fruits and Vegetables Website
                </h1>
                <p class="text-black-700 text-lg text-center mb-12">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sit amet magna id ex hendrerit semper.
                </p>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        <h2 class="text-xl font-bold text-black-800 mb-4">Services</h2>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        <h2 class="text-xl font-bold text-black-800 mb-4">About Us</h2>
                        <p class="text-black-700">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sit amet magna id ex hendrerit
                            semper.
                        </p>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        <h2 class="text-xl font-bold text-black-800 mb-4">Contact</h2>
                        <p class="text-black-700">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sit amet magna id ex hendrerit
                            semper.
                        </p>
                ...
                <div class="space-y-8 lg:space-y-0 lg:grid lg:grid-cols-12 lg:gap-8">
                    <div
                        ...
                        <div class="space-y-8">
                            <div class="space-y-4">
                                <div class="space-y-2">
                                    <h1 class="text-4xl font-bold tracking-tight text-green-900 sm:text-5xl md:text-6xl">
                                        <span class="sm:text-6xl">
                                        </span> Fresh Organic Produce
                                        <br>
                                        <span
                                            class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-green-700">Farm
                                            to Table
                                        </span>
                                        <br>
                                ...
                                <p class="text-base text-gray-700 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                    Indulge in the goodness of nature with our selection of fresh organic fruits and
                                    vegetables. From succulent berries to crisp greens, we bring you the finest produce
                            ...
                            <div class="flex space-x-4 items-center text-gray-700">
                                <div class="flex items-center space-x-2">
                                    <div class="flex flex-shrink-0 -space-x-1">
                                        <img loading="lazy" width="400" height="400" decoding="async"
                                            ...
                                            style="color:transparent" src="https://via.placeholder.com/150">
                                        <img loading="lazy" width="400" height="400" decoding="async"
                                            class="h-6 w-6 max-w-none rounded-full ring-2 ring-white"
                                            style="color:transparent" src="https://via.placeholder.com/150">
                                ...
                                <div class="h-4 border-l border-gray-700"></div>
                                <!-- Removed the Product Hunt widget -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center w-full col-span-6">
                        <div class="px-6 h-96 lg:h-100% w-full max-w-2xl col-span-6 flex items-center mx-auto">
                            <div style="width: 100%; height: 100%;">
                                <div style="width: 100%; height: 100%;">
                                    <!-- Replace the placeholder video URL with your actual video URL -->
                                    <iframe frameborder="0" allowfullscreen="1"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                        width="100%" height="100%"
                                        src="https://www.youtube.com/embed/VIDEO_ID_HERE?autoplay=0&amp;mute=0&amp;controls=0&"
                                        id="widget2">
                                    </iframe>
                                </div>
                            </div>
    ...
    <div class="max-w-screen-lg mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div class="mb-10 rounded overflow-hidden flex flex-col mx-auto text-center">
            <a href="#"
                class="max-w-3xl mx-auto text-xl sm:text-4xl font-semibold inline-block hover:text-green-600 transition duration-500 ease-in-out inline-block mb-2">Fresh
                & Organic: Explore Our Vibrant Selection of Vegetables and Fruits</a>

            <a href="#">
                <img class="w-full my-4"
                    src="https://img.etimg.com/thumb/width-640,height-480,imgsize-112836,resizemode-75,msid-106029078/tech/technology/government-may-go-high-tech-to-reduce-wastage-of-fresh-fruits-veggies/amazon-johari.jpg"
                    alt="Assortment of fresh vegetables and fruits">
            </a>
            <p class="text-gray-700 text-base leading-8 max-w-2xl mx-auto">
                Indulge in nature's bounty with our selection of freshly harvested vegetables and fruits. From crisp apples
                to leafy greens, each produce is carefully handpicked to ensure premium quality and taste. Experience the
                essence of farm-fresh goodness delivered right to your doorstep.
            </p>
            <div class="py-5 text-sm font-regular text-gray-900 flex items-center justify-center">
                <span class="mr-3 flex flex-row items-center">
                    <svg class="text-green-600" fill="currentColor" height="13px" width="13px" version="1.1"
